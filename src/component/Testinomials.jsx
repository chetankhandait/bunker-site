...
const CustomerReviews = () => {
  ...
  return (
    ...
    <section className="w-full bg-[#02312f] text-white lg:w-2/3">
  ...
  <div className="keen-slider__slide">
    {/* Review 1 content */}
    "As a commercial developer, we have worked with
numerous design firms over the years. NextSpace
stands out for their innovative designs, and ability
to meet deadlines."
  </div>
  <div className="keen-slider__slide">
    {/* Review 2 content */}
