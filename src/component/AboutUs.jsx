...
const ProfileCard = () => {
    ...
    return (
        <div className={`font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover ${theme === 'light' ? 'bg-white' : 'bg-gray-900'}`}  >
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div className="absolute top-0 right-0 h-12 w-18 p-4">
                    <button className="js-change-theme focus:outline-none" onClick={toggleTheme}>{theme === 'light' ? '🌙' : '☀'}</button>
                </div>
            </div>
        </div>
    );
