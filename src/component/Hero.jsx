          ...
          <div className="max-w-5xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="mt-8 flex flex-wrap gap-4 text-center">
              <Link
                ...
                duration={500}
                // href="#"
                className="block w-full cursor-pointer rounded bg-[#076253] px-12 py-3 text-md font-semibold text-white shadow hover:bg-green-800 focus:outline-none focus:ring active:bg-green-500 sm:w-auto"
              >
                Book your Hostel
              </Link>
